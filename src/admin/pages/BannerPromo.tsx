        ...
        {banners.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {banners.map(b => {
              ...
              const headP = b.headingPos ?? { x: 10, y: 20 };
              const titleP = b.titlePos ?? { x: 10, y: 38 };
              const descP = b.descPos ?? { x: 10, y: 60 };
                ...
                <Card key={b.id} className="overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300 border hover:border-primary/40">
                  ...
                  <div className="p-5 flex flex-col flex-1 bg-card">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-border">
                       ...
                       <div className="flex gap-2">
                          <Button variant="outline" size="sm" className="h-9 px-3 rounded-lg gap-1.5 text-xs font-semibold border border-border hover:border-primary hover:text-primary" onClick={() => openEditor(b)}>
                            <Edit2 className="w-3.5 h-3.5" /> Edit
                          </Button>
                          <Button variant="ghost" size="sm" className="h-9 px-3 rounded-lg gap-1.5 text-xs font-semibold text-destructive hover:bg-destructive/10 border border-destructive/20 hover:border-destructive/40" onClick={() => setDeleteBannerId(b.id)}>
